...
public class Page7  extends BaseGameActivity implements IAccelerometerListener {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public void onLoadResources() {
		...
		mMediaPlayer = MediaPlayer.create(this, R.raw.audiolibro7);
	}
...
//		previousSprite.setVisible(false);
		...
		final Text text = new TickerText(10, 10, this.mLetraMeievalFontM,"El poder de la siguiente R es Reducir.\n"+
																	     "Para encontrarla como antes debes pasar una\n"+
																	     "prueba pero antes tienes que saber las claves\n"+
																	     "de como utilizar su poder.\n"+
																	     "Reducir: Quiere decir utilizar menos materias \n"+
																	     "primeras, menos agua y menos energía.\n"+
																		 "-Utiliza el transporte público.\n"+
																		 "-Apaga las luces cuando no estes en la\n"+
																		 "habitación o no las necesites.\n"+
																		 "-Dúchate en lugar de bañarte.\n"+
																		 "-Cierre el grifos mientas te lavas los dientes\n"+
																		 "o cuando ayudes a fregar los platos.\n"+
																		 "-Desconecta los aparatos eléctricos cuando no\n"+
																		 "están funcionando. Por ejemplo apaga la tele\n"+
																		 "cuando no la vea nadie.\n"+
																		 "-Pon la calefacción a 21º en invierno.\n"+
																		 "-Dile a tus padres que compren bombillas de\n"+
																		 "bajo consumo.\n"+
																		 "-Dile a tus padres que pongan la lavadora\n"+
																		 "cuando el cesto de la ropa sucia este lleno."
...
//		mLecturaSound.stop();
		mMediaPlayer.stop();
		this.finish();
        startActivity(new Intent(Page7.this, JuegoReducir.class));
...
//		mLecturaSound.stop();
		...
		Intent i = new Intent(getBaseContext(), Page6.class);
	    startActivity(i);
	...
	public void actualizarEstados(){
		int seg = tiempoCrono -((int) Page7.this.mEngine.getSecondsElapsedTotal()-5);
