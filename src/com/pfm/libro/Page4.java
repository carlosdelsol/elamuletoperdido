...
public class Page4  extends BaseGameActivity implements IAccelerometerListener {
	// ===========================================================
	// Constants
	// ===========================================================
...
//			this.mMusic.setLooping(true);
			...
			this.mLecturaSound = SoundFactory.createSoundFromAsset(this.mEngine.getSoundManager(), this, "audiolibro4.ogg");
...
//		previousSprite.setVisible(false);
		...
		final Text text = new TickerText(10, 10, this.mLetraMeievalFontM, "Aunque no lo creas, eres el\n" +
																		  "descendiente de los guardianes\n" +
																		  "del amuleto, y es tu deber\n" +
																		  "encontrar sus pedazos,\n" +
																		  "aprender sus poderes y\n" +
																		  "reconstruir el amuleto para\n" +
																		  "que la tierra no muera.\n\n" +
																		  "El poder de la primera R es la\n" +
																		  "reutilización. Para\n" +
																		  "encontrarla debes pasar una\n" +
																		  "prueba pero antes tienes que\n" +
																		  "saber las claves de como\n" +
																		  "utilizar su poder.", HorizontalAlign.LEFT, 15);
...
//				Log.v("#PFM#", "Entramos en  onLoadScene() - registerUpdateHandler()");
	...
	public void actualizarEstados(){
		int seg = tiempoCrono -((int) Page4.this.mEngine.getSecondsElapsedTotal()-5);
