...
public class Page5  extends BaseGameActivity implements IAccelerometerListener {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public void onLoadResources() {
		...
		backTexR = TextureRegionFactory.createFromAsset(this.backTex, this,"gfx/fondolibro5.png", 0, 0);
		...
		mMediaPlayer = MediaPlayer.create(this, R.raw.audiolibro5);
...
//		previousSprite.setVisible(false);
		...
		final Text text = new TickerText(10, 10, this.mLetraMeievalFontM, "Reutilizar: Quiere decir no tirar las cosas\n" +
																		  "cuando todavía son útiles.\n\n"+
																		  "- Regala la ropa que te ha quedado pequeña\n" +
																		  "o que ya no usas.\n" +
																		  "- Las hojas escritas por una cara pueden\n" +
																		  "servir para dibujar\n" +
																		  "- El papel de regalo puede ser utilizado una \n" +
																		  "segunda vez\n" +
																		  "- Los juguetes que ya no utilices daselos a\n" +
																		  "otros niños que los necesiten.\n" +
																		  "- Dile a tus padres que reutilice los envases,\n" +
																		  "por ejemplo los de yogur para hacer moldes\n" +
																		  "de flan y los de mantequilla para congelar\n" +
																		  "sobrantes de comida.\n"+
																		  "- Usa trapos de cocina en vez de rollos de papel.\n" +
																		  "- Dile a tus padres que lleve su propia\n" +
																		  " bolsa o carro cuando vayan de compras.\n" +
																		  "- Utiliza unn bote de refresco como portalápices"
...
//		mLecturaSound.stop();
		mMediaPlayer.stop();
		this.finish();
        startActivity(new Intent(Page5.this, JuegoReutilizar.class));
...
//		mLecturaSound.stop();
		...
		Intent i = new Intent(getBaseContext(), Page4.class);
	    startActivity(i);
	...
	public void actualizarEstados(){
		int seg = tiempoCrono -((int) Page5.this.mEngine.getSecondsElapsedTotal()-5);
